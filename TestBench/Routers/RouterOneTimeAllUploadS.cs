...
{
    public class RouterOneTimeAllUploadS : BaseRouter
    {
        ...
        protected override async Task UploadRoutesAsync<U>()// where U: IRouteUploader
        {
            ...
            uploadFails += await DataBase.SeveralRoutesUploaderCOPYS.PropagateResultsSSAsync(connectionString,auxiliaryTable,routeTable);

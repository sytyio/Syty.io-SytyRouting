...
{
    public class PersonaRouteTableCopy
    {
        ...
        public PersonaRouteTableCopy(string connectionString)
        {
        ...
        public async Task<string> CreateDataSet(string personaOriginTable, string routingResultTable, int numberOfRows)
        {
            ...
            var auxiliaryTable = await personaRouteAuxTable.CreateAuxiliaryTableCopy(routingResultTable,numberOfRows);

...
namespace SytyRouting
{
    public class PersonaRouteTable
    {
        ...
        private async Task SetRoutingResultTableAsync()
        {
            ...
            // await using (var cmd = new NpgsqlCommand("ALTER TABLE " + personaRouteTable + " ADD COLUMN IF NOT EXISTS computed_route GEOMETRY;", connection))
            // {
            //     await cmd.ExecuteNonQueryAsync();
            // }

            // await using (var cmd = new NpgsqlCommand("ALTER TABLE " + personaRouteTable + " ADD COLUMN IF NOT EXISTS computed_route_2d GEOMETRY;", connection))
            // {
            //     await cmd.ExecuteNonQueryAsync();
            // }

            // await using (var cmd = new NpgsqlCommand("ALTER TABLE " + personaRouteTable + " ADD COLUMN IF NOT EXISTS is_valid_route BOOL;", connection))
            // {
            //     await cmd.ExecuteNonQueryAsync();
            // }
            ...
            // await using (var cmd = new NpgsqlCommand("ALTER TABLE " + personaRouteTable + " ADD COLUMN IF NOT EXISTS transport_modes TEXT[];", connection))
            // {
            //     await cmd.ExecuteNonQueryAsync();
            // }

            // await using (var cmd = new NpgsqlCommand("ALTER TABLE " + personaRouteTable + " ADD COLUMN IF NOT EXISTS time_stamps TIMESTAMPTZ[];", connection))
            // {
            //     await cmd.ExecuteNonQueryAsync();
            // }

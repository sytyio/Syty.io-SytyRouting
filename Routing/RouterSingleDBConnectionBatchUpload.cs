...
{
    public class RouterSingleConnectionBatchUpload : BaseRouter
    {
        ...
        private async Task UploadRoutesAsync2<U>(Persona[] personaArray) where U: IRouteUploader, new()
        {
            ...
            int uploadFails = await uploader.UploadRoutesAsync(connectionString,_routeTable,personaArray.ToList());
